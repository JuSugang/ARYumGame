...
public class Bar1Script : MonoBehaviour {
    ...
    public static Bar1Script instance;
    ...
    void Update()
    {
        ...
        if (Game1Manager.instance.startFlag == true && Game1Manager.instance.pauseFlag != true)
        {
            currentTime += Time.deltaTime;
            if (currentTime > playingTime)
            {
                Game1Manager.instance.startFlag = false;
                Game1Manager.instance.GameOver();
            }
            else
            {
